...
.. code-block :: php
    ...
    class MyEventSubscriber implements Speakeasy\Serializer\EventDispatcher\EventSubscriberInterface
    {
        ...
        public function onPreSerialize(Speakeasy\Serializer\EventDispatcher\PreSerializeEvent $event)
        {
            // do something
        }
    }
    ...
    $builder
        ->configureListeners(function(Speakeasy\Serializer\EventDispatcher\EventDispatcher $dispatcher) {
            $dispatcher->addListener('serializer.pre_serialize',
                function(Speakeasy\Serializer\EventDispatcher\PreSerializeEvent $event) {
                    // do something
                }
            );
...
**Event Object**: ``Speakeasy\Serializer\EventDispatcher\PreSerializeEvent``
...
**Event Object**: ``Speakeasy\Serializer\EventDispatcher\ObjectEvent``
...
**Event Object**: ``Speakeasy\Serializer\EventDispatcher\PreDeserializeEvent``
